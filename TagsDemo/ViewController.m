...
- (void)viewDidLoad {
    ...
    _tagsArray = @[
                   ...
                   @[@"全部",@"钢琴",@"吉他",@"电吉他电吉他电吉他电吉他电吉他电吉他电吉他电吉他电吉他电吉他电吉他电吉他",@"小提琴",@"架子鼓",@"口琴",@"贝斯",@"卡祖笛",@"古筝",@"翻弹",@"音乐",@"指弹",@"千本樱",@"民乐",@"初音MIKU",@"ANIMENZ",@"PENBEAT",@"木吉他",@"二胡",@"COVER",@"交响",@"权御天下",@"普通DISCO",@"OP",@"ILEM",@"原创",@"作业用BGM",@"串烧",@"东方",@"合奏",@"燃向",@"触手",@"试奏",@"ACG指弹",@"武士桑",@"触手猴",@"BGM",@"LAUNCHPAD"],
                   @[@"数学",@"物理",@"英语",@"化学",@"地理",@"历史",@"生物"],
                   @[@"全部",@"国人女声",@"中文翻唱",@"英文翻唱",@"古风",@"粤语",@"原创曲"],
                   @[@"K",@"轻音少女",@"误解向",@"我们仍未知道那天所看见的花的名字",@"华语",@"黑岩射手",@"空之境界"],
                   @[@"吐槽",@"东方",@"FATE",@"多素材",@"新人向",@"丧心病狂",@"童年"]
    ...
    _colorArray = @[RGBColor(241, 241, 241),RGBColor(124, 124, 0),RGBColor(150, 150, 150),RGBColor(200, 200, 200),RGBColor(111, 111, 111),RGBColor(241, 241, 241),RGBColor(124, 124, 124),RGBColor(150, 150, 150),RGBColor(200, 200, 200),RGBColor(111, 111, 111)];
